...
export class Matrix2D {
    ...
    /**
      ...
      * @memberOf Matrix2D
      */
    public static SRT(scaleX: number = 1, scaleY: number = 1, rad: number = 0, tx: number = 0, ty: number = 0, out?: Matrix2D): Matrix2D {
     ...
     */
    public transformPoint(p: Vector2D, out?: Vector2D): Vector2D {
        // |  a   b   tx |     x
        // |  c   d   ty |  *  y
        // |  0   0   1  |     1
     ...
     * @returns {Vector2D} (description)
     */
    public transformVector(v: Vector2D, out?: Vector2D): Vector2D {
        // |  a   b   tx |     x
        // |  c   d   ty |  *  y
        // |  0   0   1  |     0
     ...
     */
    public toArray(out: Float32Array, columnMajor: boolean = true): Float32Array {
        if (out === undefined) {
