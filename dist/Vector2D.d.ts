export declare class Vector2D {
     ...
     * @memberOf Vector2D
     */
    static fromPolar(len: number, radians: number, out?: Vector2D): Vector2D;
    /**
     * 取向量长度
     * @type {number}
     * @memberOf Vector2D
    ...
    */
     ...
     */
    scaleAbout(point: Vector2D, sx: number, sy: number): Vector2D;
    /**
     * 与缩放过的v相加
     * @param {Vector2D} v
     * @param {number} scale
     ...
     * @memberOf Vector2D
     */
    scaleAndAdd(v: Vector2D, scale: number): Vector2D;
    /**
     * 返回从此点到p2点之间的距离
     */
     ...
     * @memberOf Vector2D
     */
    rotateAbout(radians: number, point: Vector2D): Vector2D;
    /**
     ...
     * @memberOf Vector2D
     */
    rotateByVector(v: Vector2D): Vector2D;
    /**
     *  取得此向量在v向量上的投影向量
     *
     * @param {Vector2D} v
    ...
    /**
      ...
      * @memberOf Vector2D
      */
    getPerpV(v: Vector2D): Vector2D;
    /**
     * 根据入射角 = 反射角理论，计算此向量经过法向量反射后的向量
     * @param n 单位法向量
     * @returns {Vector2D} 反射后得到的向量
     */
    reflect(n: Vector2D): Vector2D;
    /**
     * 从另一个向量拷贝 xy 值
     *
     * @param {Vector2D} v
